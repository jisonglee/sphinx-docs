...
1. 운영사 및 협력사 어드민, 디렉터 계정으로 로그인하여 차량 메뉴에서
       등록 가능합니다.
...
3. 차량 상세 정보의 드라이버 영역에 드라이버 이름을 입력하면 자동으로
       검색된 리스트가 표시되며 리스트에세 드라이버를 선택 후 수정버튼을
       눌러 저장합니다.
...
|                                   | st-ID}                            |
+-----------------------------------+-----------------------------------+
| **메시지 포맷**                   | `Response <#response>`__ 참조     |
+-----------------------------------+-----------------------------------+
...
|                                   | -ID}                              |
+-----------------------------------+-----------------------------------+
| **메시지 포맷**                   | `Response <#result-1>`__ 참조     |
+-----------------------------------+-----------------------------------+
...
..
	...
	메시지 포맷은 `6.2.2. Device Activation의 Request <device-activation-request>`__ 항목을 참고합니다.
...
..
	...
	메시지 포맷은 `6.2.2. Device Activation의 Response <device-activation-response>`__ 항목을 참고합니다.
...
센서 등록 설명은 `3.3.4. 센서 등록 <#api를-활용한-등록-3>`__ 절차을 참고합니다.

2. 플랫폼은 ①번 과정에서 요청받은 정보를 기반으로 단말을 등록합니다.
